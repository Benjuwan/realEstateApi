import { memo, useRef, useEffect, useContext, ChangeEvent } from "react";
import { CompareGetFetchPrefCode } from "../../providers/compare/CompareGetFetchPrefCode";

export const CompareSelectPref = memo(() => {
    const { setGetFetchPrefCode } = useContext(CompareGetFetchPrefCode);
